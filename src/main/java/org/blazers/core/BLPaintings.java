...
/**
 * {@link BlazersMod Blazers Mod} {@link PaintingVariant Painting Variants}
 */
public final class BLPaintings {
    ...
    /**
     * The {@link DeferredRegister<PaintingVariant> Painting Variant Registry}
     */
    private static final DeferredRegister<PaintingVariant> PAINTING_VARIANTS = RegistryHelper.registry(ForgeRegistries.PAINTING_VARIANTS);
     ...
     *
     * @param name {@link String The Painting Name}
     * @return {@link RegistryObject<PaintingVariant> The registered Painting}
     */
     ...
     *
     * @param name {@link String The Painting Name}
     * @param size {@link Integer The Painting Size}
     * @return {@link RegistryObject<PaintingVariant> The registered Painting}
     */
     ...
     *
     * @param name {@link String The Painting Name}
     * @param width {@link Integer The Painting Width}
     * @param height {@link Integer The Painting Height}
     * @return {@link RegistryObject<PaintingVariant> The registered Painting}
     */
    private static RegistryObject<PaintingVariant> registerPainting(final String name, final int width, final int height) {
        return PAINTING_VARIANTS.register(name, Suppliers.memoize(() -> new PaintingVariant(width, height)));
    }
    ...
    /**
     * Register all {@link BlazersMod Blazers Mod} {@link PaintingVariant Painting Variants}
     *
