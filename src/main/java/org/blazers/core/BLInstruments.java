...
public final class BLInstruments {
    ...
    public static final ResourceKey<Instrument> BRO_GOAT_HORN = registerGoatHornKey("bro");
    ...
    private static ResourceKey<Instrument> registerInstrumentKey(final String name) {
        return ResourceKey.create(Registries.INSTRUMENT, RegistryHelper.location(name));
    }
    ...
    /**
     * Register all {@link BlazersMod Blazers Mod} {@link Instrument Instruments}
     */
    public static void registerInstruments() {
        registerInstrument(BRO_GOAT_HORN, BLSounds.GOAT_HORN_BRO);
        registerInstrument(FLY_GOAT_HORN, BLSounds.GOAT_HORN_FLY);
        registerInstrument(RESIST_GOAT_HORN, BLSounds.GOAT_HORN_RESIST);
        registerInstrument(GREAT_SKY_FALLING_COPPER_HORN, BLSounds.COPPER_HORN_GREAT_SKY_FALLING);
        registerInstrument(GREAT_SKY_FALLING_COPPER_HORN_BASS, BLSounds.COPPER_HORN_GREAT_SKY_FALLING_BASS);
        registerInstrument(GREAT_SKY_FALLING_COPPER_HORN_HARMONY, BLSounds.COPPER_HORN_GREAT_SKY_FALLING_HARMONY);
        registerInstrument(OLD_HYMN_RESTING_COPPER_HORN, BLSounds.COPPER_HORN_OLD_HYMN_RESTING);
        registerInstrument(OLD_HYMN_RESTING_COPPER_HORN_BASS, BLSounds.COPPER_HORN_OLD_HYMN_RESTING_BASS);
        registerInstrument(OLD_HYMN_RESTING_COPPER_HORN_HARMONY, BLSounds.COPPER_HORN_OLD_HYMN_RESTING_HARMONY);
        registerInstrument(PURE_WATER_DESIRE_COPPER_HORN, BLSounds.COPPER_HORN_PURE_WATER_DESIRE);
        registerInstrument(PURE_WATER_DESIRE_COPPER_HORN_BASS, BLSounds.COPPER_HORN_PURE_WATER_DESIRE_BASS);
        registerInstrument(PURE_WATER_DESIRE_COPPER_HORN_HARMONY, BLSounds.COPPER_HORN_PURE_WATER_DESIRE_HARMONY);
        registerInstrument(MUMBLE_FIRE_MEMORY_COPPER_HORN, BLSounds.COPPER_HORN_MUMBLE_FIRE_MEMORY);
        registerInstrument(MUMBLE_FIRE_MEMORY_COPPER_HORN_BASS, BLSounds.COPPER_HORN_MUMBLE_FIRE_MEMORY_BASS);
        registerInstrument(MUMBLE_FIRE_MEMORY_COPPER_HORN_HARMONY, BLSounds.COPPER_HORN_MUMBLE_FIRE_MEMORY_HARMONY);
        registerInstrument(DRY_URGE_ANGER_COPPER_HORN, BLSounds.COPPER_HORN_DRY_URGE_ANGER);
        registerInstrument(DRY_URGE_ANGER_COPPER_HORN_BASS, BLSounds.COPPER_HORN_DRY_URGE_ANGER_BASS);
        registerInstrument(DRY_URGE_ANGER_COPPER_HORN_HARMONY, BLSounds.COPPER_HORN_DRY_URGE_ANGER_HARMONY);
        registerInstrument(CLEAR_TEMPER_JOURNEY_COPPER_HORN, BLSounds.COPPER_HORN_CLEAR_TEMPER_JOURNEY);
        registerInstrument(CLEAR_TEMPER_JOURNEY_COPPER_HORN_BASS, BLSounds.COPPER_HORN_CLEAR_TEMPER_JOURNEY_BASS);
        registerInstrument(CLEAR_TEMPER_JOURNEY_COPPER_HORN_HARMONY, BLSounds.COPPER_HORN_CLEAR_TEMPER_JOURNEY_HARMONY);
        registerInstrument(FRESH_NEST_THOUGHT_COPPER_HORN, BLSounds.COPPER_HORN_FRESH_NEST_THOUGHT);
        registerInstrument(FRESH_NEST_THOUGHT_COPPER_HORN_BASS, BLSounds.COPPER_HORN_FRESH_NEST_THOUGHT_BASS);
        registerInstrument(FRESH_NEST_THOUGHT_COPPER_HORN_HARMONY, BLSounds.COPPER_HORN_FRESH_NEST_THOUGHT_HARMONY);
        registerInstrument(SECRET_LAKE_TEAR_COPPER_HORN, BLSounds.COPPER_HORN_SECRET_LAKE_TEAR);
        registerInstrument(SECRET_LAKE_TEAR_COPPER_HORN_BASS, BLSounds.COPPER_HORN_SECRET_LAKE_TEAR_BASS);
        registerInstrument(SECRET_LAKE_TEAR_COPPER_HORN_HARMONY, BLSounds.COPPER_HORN_SECRET_LAKE_TEAR_HARMONY);
        registerInstrument(FEARLESS_RIVER_GIFT_COPPER_HORN, BLSounds.COPPER_HORN_FEARLESS_RIVER_GIFT);
        registerInstrument(FEARLESS_RIVER_GIFT_COPPER_HORN_BASS, BLSounds.COPPER_HORN_FEARLESS_RIVER_GIFT_BASS);
        registerInstrument(FEARLESS_RIVER_GIFT_COPPER_HORN_HARMONY, BLSounds.COPPER_HORN_FEARLESS_RIVER_GIFT_HARMONY);
        registerInstrument(SWEET_MOON_LOVE_COPPER_HORN, BLSounds.COPPER_HORN_SWEET_MOON_LOVE);
        registerInstrument(SWEET_MOON_LOVE_COPPER_HORN_BASS, BLSounds.COPPER_HORN_SWEET_MOON_LOVE_BASS);
        registerInstrument(SWEET_MOON_LOVE_COPPER_HORN_HARMONY, BLSounds.COPPER_HORN_SWEET_MOON_LOVE_HARMONY);
    }
