...
/**
 * {@link BlazersMod Blazers Mod} {@link Model Thrown Spear Model}
 */
@OnlyIn(Dist.CLIENT)
public final class ThrownSpearModel extends Model {

    /**
     * The {@link ModelLayerLocation Model Layer Location}
     */
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(RegistryHelper.location("thrown_spear"), "main");
    /**
