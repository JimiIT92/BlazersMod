...
/**
 * Implementation interface for the {@link BlazersMod Blazers Mod}  {@link ButtonBlock Cut Copper Bricks}
 */
public interface IWeatheringCutCopperBricks extends ChangeOverTimeBlock<WeatheringCopper.WeatherState> {
